...
export const EnvSchema = z.object({
  ...
  MANAGED_POSTGRES_ADMIN_URL: z.string().default(''),
  MANAGED_POSTGRES_RUNTIME_HOST: z.string().default(''),
  MANAGED_POSTGRES_RUNTIME_PORT: envInteger(z.number().int().min(1).max(65535), 5432),
  MANAGED_POSTGRES_RUNTIME_SSL_MODE: z.enum(['disable', 'prefer', 'require']).default('disable'),
