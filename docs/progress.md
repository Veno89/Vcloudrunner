...
- what was built:
  ...
  - added direct ingress regression coverage for allowlisted and blocked CORS origin handling, rate-limit headers/throttling, and shared error-handler preservation of plugin-provided `429` responses
