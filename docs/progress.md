...
- **Phase 2: Production readiness foundation** — ~65% complete
  ...
  - left (~35%): deeper observability dimensions, migration safety gates, backup/restore automation checks, worker/service decomposition, and broader operational validation
