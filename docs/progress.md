...
- **Phase 2: Production readiness foundation** — ~85% complete
  ...
  - left (~15%): deeper observability dimensions, migration safety gates, backup/restore automation checks, worker/service decomposition, and broader operational validation
