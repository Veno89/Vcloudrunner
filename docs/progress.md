...
- what was built:
  ...
  - added api-token route regression coverage for admin cross-user access, user-boundary denial, missing write scope, and token-rotate not-found handling
