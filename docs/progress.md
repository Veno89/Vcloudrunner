...
- **Phase 2: Production readiness foundation** — ~84% complete
  ...
  - left (~16%): deeper observability dimensions, migration safety gates, backup/restore automation checks, worker/service decomposition, and broader operational validation
